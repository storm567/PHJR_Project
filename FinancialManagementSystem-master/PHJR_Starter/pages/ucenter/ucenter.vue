<template>
	<view class="center">
		...
		<uni-grid class="grid" :column="4" :showBorder="false" :square="true">
			<uni-grid-item class="item" v-for="(item,index) in gridList" @click.native="tapGrid(item.url)" :key="index">
		...
		data() {
			return {
				gridList: [{ //卡包，认证，我的贷款
						"text": "我的贷款",
						"icon": "list",
						"url": "/pages/ucenter/mycart/mycart"
					},
					{
						"text": "个人认证",
						"icon": "person",
					...
					},
					{
						"text": "企业认证",
						"icon": "staff",
						"url": "/pages/ucenter/identify/com_identification"
					},
					{
						"text": "我的卡包",
						"icon": "wallet",
